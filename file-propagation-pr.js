...
module.exports = ({github, config, pr_data, head_branch, issue_number}) => {
    (async () => {
        console.log('github', github, 'config', config, 'pr_data', pr_data, 'head_branch', head_branch, 'issue_number', issue_number)
